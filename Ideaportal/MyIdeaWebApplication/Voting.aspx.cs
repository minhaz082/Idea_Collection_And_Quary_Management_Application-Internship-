...
namespace MyIdeaWebApplication
{
    public partial class Voting : System.Web.UI.Page
    {
        ...
        //here is The calculation of percentage in Result table
        ...
        protected void readXML()
        {
            ...
            if (ds.Tables.Count > 0)
            {
                ...
                {
                    if (ds.Tables[0].Rows[i][0].ToString() == "Kibria Suman, GPIT")
                        mCount++;
                    else if (ds.Tables[0].Rows[i][0].ToString() == "Shamim Ahmed, TNO")
                        iCount++;
                    else if (ds.Tables[0].Rows[i][0].ToString() == "Ashiqur Rahman, Finance")
                        gCount++;
                }
                double theTotal;
        ...
        //here is the binding of bar increases on percentage up
